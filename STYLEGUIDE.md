...
This is a general style guide that shall govern over all `JsonDart` repositories. The aim is
...
- You must always use relative imports for imports within the `JsonDart` library
