...
This is a general style guide that shall govern over all **JsonDart** project. The aim is
...
- You must always use relative imports for imports within the `json_dart` library
